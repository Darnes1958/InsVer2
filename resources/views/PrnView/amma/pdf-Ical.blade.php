...
@section('mainrep')
 ...
 @endphp
    ...
    <div style="text-align: center">
        ...
        <label class="bg-gray-100 text-lg font-extrabold">{{$res->tran_no}}</label>
    </div>
    ...
    <div >
        ...
        <label class="text-lg bg-gray-50">{{$res->tran_date}}</label>
    </div>
    <br>
    <div>
        <label class="text-lg " >استلمت من السيد :&nbsp;&nbsp; </label>
        <label class="text-lg font-extrabold bg-gray-50">{{$res->jehaTable->jeha_name}}</label>
    </div>
    <br>
    <div>
