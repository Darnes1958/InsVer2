...
@section('mainrep')
  ...
  <table  width="100%"   align="right" >
      ...
      @if($tar_type=='1')
        <caption style="font-size: 12pt; margin: 8px;">{{'الأقساط المرجعة من الفائض من تاريخ '.$tar_date1.' من إلي تاريخ  '.$tar_date2 }} </caption>
      @else
        <caption style="font-size: 12pt; margin: 8px;">{{'الأقساط المرجعة من الخطأ من تاريخ '.$tar_date1.' من إلي تاريخ  '.$tar_date2 }} </caption>
      @endif
